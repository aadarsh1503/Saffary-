...
const ContactPage = () => {
  return (
    <div id="contact" className="">
      ...
      {/* Map Section */}
      <div className=''>
      <div className="flex p-6 shadow-custom rounded-xl flex-col w-3/4 ml-[180px] items-center space-y-4 mb-20">
  ...
  <iframe
    ...
    width="100%"
    height="400"
    className="rounded-xl shadow-custom w-full max-w-4xl"
    allowFullScreen
  ></iframe>

  {/* Address Section */}
  <p className="text-left relative right-40 whitespace-nowrap   text-gray-700">
