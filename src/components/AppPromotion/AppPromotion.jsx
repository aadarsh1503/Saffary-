...
function AppPromotion() {
  ...
  <span class="absolute left-0 top-1/2 transform -translate-y-1/2 ml-0 lg:ml-12 w-24 border-t border-white"></span>
  OR
  <span class="absolute right-0 top-1/2 left-0 lg:left-56 -ml-10  transform -translate-y-1/2 w-24 border-t border-white"></span>
</span>
